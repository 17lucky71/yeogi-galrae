...
상단 메뉴(모바일은 ☰ 햄버거 메뉴)로 4개 섹션을 이동할 수 있고, 각 섹션은 아래 주소로 바로 접속할 수도 있습니다.

| 섹션 | 바로가기 주소 | 내용 | 스크린샷 |
|---|---|---|---|
| 홈 | https://yeogi-galrae.vercel.app/#home | 서비스 한 줄 소개와 예시 코스 카드 | [보기](docs/screenshots/스크린샷%202026-09-25%20150709.png) |
| 서비스 소개 | https://yeogi-galrae.vercel.app/#about | 3단계 사용 방법 (조건 고르기 → AI 코스 설계 → 확인·복사) | [보기](docs/screenshots/스크린샷%202026-09-25%20150751.png) |
| AI 코스 추천 | https://yeogi-galrae.vercel.app/#planner | 조건 입력 → AI가 일자별 타임라인 코스 + 여행 팁 생성 | [보기](docs/screenshots/스크린샷%202026-09-25%20150841.png) |
| 자주 묻는 질문 | https://yeogi-galrae.vercel.app/#faq | 정확도, 해외 지역, 오류 메시지, 개인정보 저장 여부 안내 | [보기](docs/screenshots/스크린샷%202026-09-25%20152056.png) |
